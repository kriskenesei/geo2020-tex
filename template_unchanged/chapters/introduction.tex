...
\toprule
\multicolumn{1}{c}{} & \multicolumn{2}{c}{3D model} &  & \multicolumn{2}{c}{input} \\ \cmidrule(lr){2-3} \cmidrule(l){5-6} 
\multicolumn{1}{c}{} & \multicolumn{1}{c}{solids} & \multicolumn{1}{c}{faces} &  & \multicolumn{1}{c}{vertices} & \multicolumn{1}{c}{constraints} \\ \midrule
\textbf{campus} & 370   & 4298  &  & 5970   & 3976  \\
\textbf{kvz}    & 637   & 6549  &  & 8951   & 13571 \\
\textbf{engelen}& 1629  & 15870 &  & 23732  & 15868 \\ \bottomrule
\end{tabular}
\caption{My own reproduction of the above example table.}
\label{tab:example2}
\end{table}
