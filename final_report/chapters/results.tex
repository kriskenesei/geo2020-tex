...
The third reason is the violation of one or more of the trio of threshold-based evaluations (minimum width, width change, elevation change). This is comparatively rare, but some of the missing cross-sections in the images on the left in Figure \ref{fig:edgeapproximation0} are due to this.
