...
Using general curve fitting or an interconnected set of splines (rather than using fixed-degree polynomials) could also help solve this issue, but the toll this would take on the computational complexity and the complexity of the code is not justified by the issues that arise.
