...
As scaling was not part of this project, the task of creating such manageable subsets of the data was carried out manually prior to starting development on the main processing steps. This procedure consisted of cropping the input vector datasets into tiles, and keeping only those Lidar points which which fall within a set maximum distance from the road network centrelines. Furthermore, points not classed as ground or bridge points are discarded, which is explained in more depth in Section [REF].
