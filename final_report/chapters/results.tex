...
The performance of this step is also heavily reliant on the input Lidar thinning. A thinning factor of two also means that we are still working with 3 to 5 Lidar points per square metre, which results in mediocre performance. While I used performance-focused 
