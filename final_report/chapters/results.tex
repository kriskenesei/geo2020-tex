...
The optimised contours are shown overlain on the attractor maps in Figure \ref{fig:activecontouroptimisation1}. While the \textit{general} appearance of the contours (Figure \ref{fig:activecontouroptimisation0}) is acceptable in many places, comparing them with the attractor maps reveals that they are not reliably positioned on the break in smoothness. Although 
