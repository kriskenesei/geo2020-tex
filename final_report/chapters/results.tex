...
The second line of the code snippet writes the accuracy assessment results to disk as a CSV file - \codeword{errors_fpath} represents the file path where the CSV file should be deposited. This is necess
