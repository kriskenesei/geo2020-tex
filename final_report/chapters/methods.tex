...
The focus of each subsection below is to explain, with the help of accurate flowcharts, how each pipeline step works, and to discuss major challenges encountered during development and how they affected the course of development. Most of these can be interpreted as further details about the top-level changes relative to the P2 plans that I already described in Section \ref{sub:pipelineoverview} above.
