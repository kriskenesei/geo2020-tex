...
A typical, practical example is as follows: the Lidar segmentation workflow encounters a bridge. Only one DTB line exists locally, and its vertices (and densified vertices) are added to the subcloud. The road is straight, so even thought the prelimi
