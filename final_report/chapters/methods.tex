...
\begin{figure}
    \centering
    \includegraphics[width=0.94\linewidth]{final_report/figs/edge_optimisation.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.92\linewidth]{final_report/figs/elevation_interpolation.pdf}
